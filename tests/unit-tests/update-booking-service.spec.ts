...
import { UpdateBookingServiceUseCase } from '@/use-cases/update-booking-service'

describe('Update Service Booking Use Case', () => {
	...
	let sut: UpdateBookingServiceUseCase
	...
	beforeEach(async () => {
		...
		sut = new UpdateBookingServiceUseCase(
		...
		for (const { weekDay, id } of professionalSchedule) {
			professionalSchedulesRepository.items.set(id, {
				id: `${id}-01`,
				startTime: '08:00',
				minutesWorking: 600,
				breakTime: '12:00',
