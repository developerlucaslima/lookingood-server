...
import { ServiceBookingConfirmationUseCase } from '@/use-cases/service-booking-confirmation'

let bookingsRepository: InMemoryBookingsRepository
let establishmentsRepository: InMemoryEstablishmentsRepository
let sut: ServiceBookingConfirmationUseCase

describe('Service Booking Confirmation Use Case', () => {
  beforeEach(async () => {
    bookingsRepository = new InMemoryBookingsRepository()
    establishmentsRepository = new InMemoryEstablishmentsRepository()
    sut = new ServiceBookingConfirmationUseCase(
      bookingsRepository,
